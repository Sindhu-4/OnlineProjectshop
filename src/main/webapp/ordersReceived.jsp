            ...
            <td><i class="fa fa-inr"></i><%=rs.getString(5)%></td>               
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(10) %></td>
               ...
               <td><a href="cancelOrdeAction.jsp?id=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>">Cancel <i class='fas fa-window-close'></i></a></td>
                <td><a href="deliverOrdersAction.jsp?id=<%=rs.getString(1)%>&email=<%=rs.getString(2)%>">Delivered <i class='fas fa-dolly'></i></a></td>
            </tr>
    <%   
    	}
    }
