...
<input class="input-style" type="text" name="transctionId" placeholder="Enter Transction ID">
...
<div class="left-div">
<h3>Mobile Number</h3>
<input class="input-style" type="text" name="mobileNumber" value="<%=rs2.getString(3)%>" placeholder="Enter Mobile Number">
